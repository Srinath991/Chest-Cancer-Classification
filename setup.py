...
AUTHOR = 'Srinath V'
SRC_REPO = 'chestCancerNet'
AUTHOR_EMAIL = 'srinathvsrinatv863@gmail.com'
DESCRIPTION = "Python package designed for building and training Convolutional Neural Networks (CNNs) to classify chest cancer images"
